...
import 'user_status.dart' as _i6;
import 'package:chatroom_server/src/generated/chat_message.dart' as _i7;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i6.UserStatus) {
      return _i6.UserStatus.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i6.UserStatus?>()) {
      return (data != null ? _i6.UserStatus.fromJson(data) : null) as T;
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'UserStatus') {
      return deserialize<_i6.UserStatus>(data['data']);
    }
